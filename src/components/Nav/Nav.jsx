...
export default function Nav() {
  ...
  return (
    <Disclosure
      ...
      className={
        color
          ? " top-0 w-full bg-white duration-100 shadow-xl sticky z-50"
          : "  mx-auto max-w-7xl duration-100 z-[1000]  rounded-full px-2 sticky top-5 bg-white z-100 "
      }
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 justify-between items-center">
              <div className="relative z-10 flex px-2 lg:px-0">
                <div className="flex flex-shrink-0 items-center gap-x-4">
                  ...
                  <div className="lg:block hidden hover:bg-slate-200 py-1 px-2 rounded-lg">
                    For individuals
                  </div>
                  <NavLink
                    to={"/charity"}
